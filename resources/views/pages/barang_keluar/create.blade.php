                                ...
                                <div class="col-lg-12">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- <select class="select2 show-tick form-control required" name="user" data-style="btn-inverse" required {{($action=='/barang_keluar/'.$barang_keluar->id)?'disabled':''}}>
                                                    <option value="">Pilih Barang</option>
                                                    @foreach($barang as $dt)
                                                    <option value="{{$dt->id}}">{{$dt->nama}} / {{$dt->merk}}</option>
                                                    @endforeach
                                                </select> -->
...
<script src="{{asset('assets/js/barang_keluar.js')}}"></script>
@endsection
