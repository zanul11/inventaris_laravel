...
@section('content')
<div id="content" class="content" ng-app="app" ng-controller="BarangKeluarController" ng-init="init('{{$kwitansi->kode}}','{{$kwitansi->pj}}','{{$kwitansi->diterima}}', '{{ csrf_token() }}', '{{date('Y-m-d',strtotime($kwitansi->tgl))}}', {{$kwitansi->jenis}})">
    <!-- begin breadcrumb -->
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Kwitansi Pembayaran <small>Edit Data</small></h1>

    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        <!-- begin panel-heading -->
        <div class="panel-heading ui-sortable-handle">
            <h4 class="panel-title">Form Edit Data Kwitansi Pembayaran</h4>
                ...
                <div class="col-md-3">
                    <!-- <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="nomor" class="form-control" style="display: block;" value="{{$kwitansi->kode}}" name="password" disabled>
                        </div>
                    </div> -->
                    <div class="form-group">
                        <label class="control-label">PJ</label>
                        <select data-width="100%" class="select2 form-control form-control-solid" ng-model="selectedPegawai" ng-options="pegawai.nip + ' - '  + pegawai.nm_pegawai  for pegawai in pegawais">
                ...
                <div class="col-md-4">
                    <div class="note note-green">
                        <div class="note-content">
                            ...
                            <hr>
                            <div class="height-250" style="display: block; position: relative; overflow: auto;">
                                <div class="col-lg-12">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label">Untuk pembelian?</label>
                                            <div class="input-group">
                                                <textarea type="text" class="form-control" style="display: block;" ng-model="ket" rows="5"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script src="{{asset('assets/js/kwitansi_edit.js')}}"></script>
@endsection
