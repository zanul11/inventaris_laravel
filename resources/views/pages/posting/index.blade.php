...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item"><a>Posting</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header text-danger font-weight-bold"><span class="text-custom">POSTING</span> ABSEN</h1>
    ...
    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <form action="/posting" method="post" data-parsley-validate="true" data-parsley-errors-messages-disabled="">
            @csrf
