...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('./assets/img/wp9031357.jpg');
        }
...
<body>
    ...
    <div class="ibox login-content">
        ...
        <form class="ibox-body" id="login-form" action="{{url('/auth')}}" method="GET">
            @csrf
            ...
            <h6 class="font-strong text-center mb-5">APLIKASI INVENTARIS &copy {{date('Y')}}</h6>
        </form>
    </div>
