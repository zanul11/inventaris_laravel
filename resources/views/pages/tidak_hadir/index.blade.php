    ...
    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-heading">
            <div class="row width-full">
                <div class="col-lg-3">
                    <a href="{{url('/tidak_hadir/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                </div>
                <div class="col-lg-3">
            ...
            <table class="table table-hover data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{date('d-m-Y', strtotime($dt->tgl_mulai))}} s/d {{date('d-m-Y', strtotime($dt->tgl_akhir))}}</td>
