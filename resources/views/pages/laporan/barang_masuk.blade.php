...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item"><a href="">Laporan Barang Masuk</a></li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Laporan <small>barang masuk...</small></h1>
    <!-- end page-header -->
    <!-- begin row -->
    <div class="panel panel-primary" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-heading">
            <div class="row width-full">
                <form method="POST" action="/laporan-masuk">
                    @csrf
                    <div class="col-lg-12">
                ...
                <form method="POST" action="/laporan-masuk/1" target="_blank">
                    @csrf
                    @method('PUT')
                    <div class="col-lg-12">
                        <div class=" form-inline">
