...
<div id="content" class="content" ng-app="app" ng-controller="BarangKeluarController">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header text-danger font-weight-bold"><span class="text-custom">TAMBAH DATA</span> PEMINJAMAN PERALATAN</h1>
...
<script src="{{asset('assets/js/pinjam.js')}}"></script>
@endsection
